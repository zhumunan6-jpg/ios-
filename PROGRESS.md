...
- Added an iOS-focused README tutorial covering GitHub Pages, Home Screen PWA setup, local Wi-Fi testing, supported formats, large files, and troubleshooting.
